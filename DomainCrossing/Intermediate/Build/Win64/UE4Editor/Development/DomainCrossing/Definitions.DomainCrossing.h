#undef DOMAINCROSSING_API
#undef DOMAINCROSSING_VTABLE
...
#define UE_PROJECT_NAME DomainCrossing
...
#define DOMAINCROSSING_VTABLE DLLEXPORT_VTABLE
#define DOMAINCROSSING_API DLLEXPORT
